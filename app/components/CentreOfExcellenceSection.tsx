          ...
          <div>
            <FadeUp>
              <div className="flex items-center gap-3 mb-4">
                ...
                >
                  Centre of Excellence on Agritech
                </span>
              </div>
            </FadeUp>
            ...
            <FadeUp delay={0.15}>
              <p className="mb-10 leading-relaxed" style={{ color: "rgba(255,255,255,0.65)" }}>
                Myefarm aims to contribute to the Centre of Excellence by
                demonstrating what is possible when technology, community, and
                purpose align — creating models that can be studied, replicated,
                and scaled across India&apos;s agricultural landscape.
              </p>
            </FadeUp>
